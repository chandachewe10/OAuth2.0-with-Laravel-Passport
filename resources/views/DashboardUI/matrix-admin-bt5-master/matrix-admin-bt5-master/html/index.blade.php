            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Personal Profile</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Company Profile</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Ballance Due</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Application</span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="{{route('developers.application')}}" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu">Create New App  </span></a
                    >
                  </li>
                  <li class="sidebar-item">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Sample API's</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">KYC Form</span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="icon-material.html" class="sidebar-link"
                      ><i class="mdi mdi-emoticon"></i
                      ><span class="hide-menu"> Fill in Your KYC Form  </span></a
                    >
...
<!--Show Success message here if Client_Id and Client_Secret Created Successfully--> 

<!-- Successs Application for Oath2.0 -->
@if (session('success'))
...
<!--Continue Now-->
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-success text-center">
                  ...
                  <h6 class="text-white">Personal Profile</h6>
                </div>
              </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-warning text-center">
                  ...
                  <h6 class="text-white">Company Profile</h6>
                </div>
              </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-info text-center">
                  ...
                  <h6 class="text-white">Ballance Due</h6>
                </div>
              </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                  ...
                  <h6 class="text-white">KYC Forms</h6>
                </div>
              </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-info text-center">
                  ...
                  <h6 class="text-white"><a href="{{route('developers.application')}}" style="color:white">Create New App</a></h6>
                </div>
              </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-success text-center">
                  ...
                  <h6 class="text-white">Sample API's</h6>
                </div>
              </div>
            </div>
            <!-- Column -->
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center">
                    <div>
                      <h4 class="card-title">{{Auth::user()->name}}'s Application Analysis</h4>
        ...
        <footer class="footer text-center">
          Some Rights Reserved by kwaChaCredit. Designed and Developed by
          <a href="https://www.chandachewe.com">Chanda Chewe</a>.
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
